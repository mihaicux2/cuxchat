...
public class CuxStringEncrypter {

    Cipher ecipher;
    Cipher dcipher;

    /**
     * Static constant. Used as a key passphrase for the encryption of strings
     */
    public static final String passKey = "@(W>*D'4Is#'%"; // 128 bit key [you should change this ;) ]

    /**
     * Constructor used to create this object.  Responsible for setting
     * and initializing this object's encrypter and decrypter Chipher instances
     * given the default Pass Phrase and algorithm.
     */
    public CuxStringEncrypter(){
        this(CuxStringEncrypter.passKey);
    }
     ...
     *                   decrypter instances.
     */
    public CuxStringEncrypter(SecretKey key, String algorithm) {
        try {
     ...
     *                   decrypter instances.
     */
    public CuxStringEncrypter(String passPhrase) {
...
//            byte[] dec = BBase64.decode(str).getBytes("UTF8");
    ...
    public static void testUsingSecretKey() {
        try {
            ...
            CuxStringEncrypter desEncrypter = new CuxStringEncrypter(desKey, desKey.getAlgorithm());
            CuxStringEncrypter blowfishEncrypter = new CuxStringEncrypter(blowfishKey, blowfishKey.getAlgorithm());
            CuxStringEncrypter desedeEncrypter = new CuxStringEncrypter(desedeKey, desedeKey.getAlgorithm());
    ...
    public static void testUsingPassPhrase() {
        ...
        // Create encrypter/decrypter class
        CuxStringEncrypter desEncrypter = new CuxStringEncrypter(passPhrase);
