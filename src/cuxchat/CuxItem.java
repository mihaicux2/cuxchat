/**
 *  The CuxItem class is designed to be used by Swing components that use a
...
public class CuxItem<V> implements Comparable<CuxItem>
{
	private V value;
	 ...
	 */
	public CuxItem(V value, String description)
	{
		this.value = value;
	 ...
	 */
	public int compareTo(CuxItem item)
	{
